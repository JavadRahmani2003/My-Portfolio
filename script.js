...
function Fullscreener(imgSrc) {
    const ImageFullScreen = document.getElementById("ImageFullScreen");
    const ImageSrc = document.getElementById("TheImageSRC");
    
    ImageFullScreen.style.display = "block";
    ImageSrc.src = imgSrc;
    ImageSrc.style.display = "flex";
}

document.getElementById("ImageFullScreen").onclick = function() {
